...
![vetka](vetka.png)
## __Цитаты__
>Работа с ветками может помочь вам организовать работу над большими проектами и совмещать работу нескольких людей над одним проектом. Хорошо продуманное использование веток может помочь избежать конфликтов и трений при слиянии изменений. При этом необходимо помнить про атрибуты безопасности и не трогать ветки, к которым у вас нет доступа, и про важность описательных названий веток, которые помогут вам и вашим коллегам быстро ориентироваться в рамках проекта.
